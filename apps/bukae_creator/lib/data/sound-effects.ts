...
export const soundEffectsMetadata: SoundEffectMetadata[] = [
  ...
  { "category": { "en": "suspence", "ko": "서스펜스" }, "label": "놀라는배경", "key": "long" },
  { "category": { "en": "suspence", "ko": "서스펜스" }, "label": "허얽", "key": "heak" },
  { "category": { "en": "suspence", "ko": "서스펜스" }, "label": "안 좋은 예감", "key": "dduddung" },
  { "category": { "en": "suspence", "ko": "서스펜스" }, "label": "엔딩 쿵", "key": "ending" },
  { "category": { "en": "suspence", "ko": "서스펜스" }, "label": "Suspense 1", "key": "Suspense1" },
  { "category": { "en": "suspence", "ko": "서스펜스" }, "label": "Suspense 2", "key": "Suspense2" },
  { "category": { "en": "suspence", "ko": "서스펜스" }, "label": "Suspense 3", "key": "Suspense3" },
  { "category": { "en": "suspence", "ko": "서스펜스" }, "label": "Suspense 4", "key": "Suspense4" },
  { "category": { "en": "suspence", "ko": "서스펜스" }, "label": "Suspense 6", "key": "Suspense6" },
  { "category": { "en": "suspence", "ko": "서스펜스" }, "label": "Suspense 7", "key": "Suspense7" },
  { "category": { "en": "suspence", "ko": "서스펜스" }, "label": "Suspense 8", "key": "Suspense8" },
  ...
  { "category": { "en": "percussion", "ko": "타악기" }, "label": "큰 북 (퉁)", "key": "tund" },
