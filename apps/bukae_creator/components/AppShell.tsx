  ...
  const getEllipseConfig = () => {
    switch (currentStep) {
      ...
      case 3:
        // Step3: 하단 배치
        return {
          position1: { bottom: '30%', left: '15%', transform: 'translateY(30%)' },
          position2: { bottom: '15%', left: '-19%', transform: 'translateY(40%)' },
          position3: { bottom: '15%', right: '-13%', transform: 'translateY(20%)' },
        }
      default:
        // 기본값: 하단 배치
        return {
