  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <textarea
        ...
        rows={5}
        className="w-full px-6 py-4 rounded-lg border border-white/40 bg-transparent font-16-rg text-white/80 resize-none focus:outline-none focus:border-white/60 placeholder:text-white/35"
      />
    </div>
  )
}
