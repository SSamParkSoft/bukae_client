...
export const FOLLOW_UP_FINALIZE_PROGRESS_MESSAGES = [
  '잠시만 기다려주세요. 거의 다 준비됐어요.',
  '장면별 촬영 포인트를 정리하고 있어요.',
  '후킹 구간과 CTA 흐름을 다시 점검하고 있어요.',
  '대본 톤과 컷 구성을 다듬고 있습니다.',
  '답변 내용을 바탕으로 핵심 메시지를 압축하고 있어요.',
  '레퍼런스 분석 결과와 기획 방향을 맞춰 보고 있어요.',
  '촬영 난이도와 구성 흐름을 함께 검토하고 있어요.',
  '완성된 기획안에서 빠진 정보가 없는지 확인하고 있어요.',
  '장면 전환과 내레이션 흐름을 조정하고 있어요.',
  '최종 요약을 생성하기 전에 결과를 한 번 더 점검하고 있습니다.',
  '조금만 기다려 주세요. 결과를 거의 준비하고 있어요.',
] as const
